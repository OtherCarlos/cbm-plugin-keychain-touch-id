...
- (instancetype)init
{
    ...
    if (self) {
        ...
        // This keychain item is a accessible when this device only is unlocked.
        [_genericPasswordQuery setObject:(__bridge id)kSecAttrAccessibleWhenUnlockedThisDeviceOnly
...
- (void)mySetObject:(id)inObject forKey:(id)key
{
    ...
    {
        [_keychainData setObject:(__bridge id)kSecAttrAccessibleWhenUnlockedThisDeviceOnly
                          forKey:(__bridge id)kSecAttrAccessible];
